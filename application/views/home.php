    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          ...
          <ul>
            <li>Rekomendasi dibuat berdasarkan COBIT 4.1.</li>
            <li>Anda akan mengetahui maturity level perusahaan Anda sekarang.</li>
            <li>Anda akan mendapatkan rekomendasi tata kelola teknologi informasi.</li>
          </ul>
