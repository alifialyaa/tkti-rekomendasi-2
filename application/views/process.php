  ...
  <main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <h2>Pemilihan IT Process</h2>
      </div>
    </section><!-- End Breadcrumbs -->

    <section class="kuis">
      <div class="container">
      <form action="<?= site_url('kuesioner/index') ?>" role="form" method="POST" id="formProcess">
        <?php foreach ($process as $process): ?>
            <div class="card my-4 mx-3">
                <div class="card-body">
                    <tr>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="radio4" id="inlineRadio4" value="<?php echo $process->id_it_process; ?>">
                            <label class="form-check-label" for="inlineRadio4"><?php echo $process->it_process ?></label>
                        </div>
                        <br>
                    </tr>
                </div>
